...
const features = [
  ...
  },
  {
    ...
    description: 'Receive tailored advice by selecting your target job role for more relevant suggestions.',
  },
  {
    icon: <KeyRound className="h-8 w-8 text-primary" />,
    title: 'Missing Keywords Detection',
    description: 'Uncover the exact keywords and skills you need to add for your specific career path.',
  },
  {
    icon: <FileUp className="h-8 w-8 text-primary" />,
    title: 'DOC/DOCX Resume Upload',
    description: 'Easily upload your resume in .doc or .docx format for a quick and seamless analysis.',
  },
  {
    icon: <Sparkles className="h-8 w-8 text-primary" />,
    title: 'AI Summary Improvement',
    description: 'Let AI craft a powerful, attention-grabbing professional summary for you in seconds.',
  },
  {
  ...
  return (
    <section id="features" className="w-full py-12 md:py-24 lg:py-32">
      <div ref={ref} className={cn("container px-4 md:px-6 transition-all duration-700 ease-out", inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10")}>
        ...
        <div className="mx-auto grid max-w-5xl items-stretch gap-6 sm:grid-cols-2 md:gap-8 lg:max-w-none lg:grid-cols-3 mt-12">
